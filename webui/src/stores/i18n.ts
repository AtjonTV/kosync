...
const translations: Record<Locale, Record<string, string>> = {
  ...
  de: {
    ...
    setup_desc: 'Um Ihren Lesefortschritt in KOReader zu synchronisieren, verwenden Sie das offizielle KOReader Sync-Plugin mit diesem Server.',
    server_address: 'Serveradresse',
    auth_method: 'Authentifizierungsmethode',
    auth_method_desc: 'Geben Sie die folgenden Zugangsdaten in KOReader ein:',
    username: 'Benutzername',
    password: 'Passwort',
    api_token_title: 'Alternativ über benutzerdefinierten API-Token konfigurieren',
    api_token_desc: 'Bei der KOReader-Einrichtung können Sie auch diesen Token anstelle von Basic Auth verwenden:',
    api_token: 'API-Token',
    my_documents: 'Meine Dokumente',
    login_prompt: 'Bitte anmelden, um Ihre Dokumente zu sehen.',
    setup_koreader_title: 'KOReader Sync einrichten',
    setup_step_1: 'Setzen Sie den <strong>Benutzerdefinierten Sync-Server</strong> auf <code>{0}</code>',
    setup_step_2: '<strong>Registrieren</strong> Sie ein neues Konto.',
    setup_step_3: 'Aktivieren Sie <strong>Dokumente automatisch synchron halten</strong>.',
    setup_step_4: 'Setzen Sie <strong>periodisch synchronisieren alle # Seiten</strong> auf 2.',
    setup_step_5: 'Setzen Sie <strong>Dokumenten-Abgleichsmethode</strong> auf "Binär".',
    setup_step_6: 'Melden Sie sich auf allen Geräten an und wiederholen Sie die Schritte 3-5.',
    setup_step_7: 'Melden Sie sich bei KOsync an',
    ...
    delete_doc_confirm: 'Sind Sie sicher, dass Sie "{0}" löschen möchten?',
    ...
    delete_history_confirm: 'Sind Sie sicher, dass Sie diesen Verlaufseintrag vom {0} löschen möchten?',
    restore_history_confirm: 'Sind Sie sicher, dass Sie das Dokument auf den Stand vom {0} zurücksetzen möchten?',
    col_previous_title: 'Vorheriger Titel',
    col_when: 'Wann',
    no_history: 'Kein Verlauf gefunden.',
    no_history_desc: 'Dieses Dokument hat keinen Verlauf.<br>Sie können versuchen, Ihren Fortschritt hochzuladen und Ihre automatische Upload-Einstellung zu überprüfen.',

    // LoginModal
    login_header: 'Anmelden',
    err_fields_required: 'Bitte geben Sie sowohl den Benutzernamen als auch das Passwort ein.',
